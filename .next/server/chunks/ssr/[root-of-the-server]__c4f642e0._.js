...
function SignInPage() {
    ...
    const handleGoogleSignIn = async ()=>{
        ...
        try {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["shouldShowErrorToUser"])(error)) {
                const { title, description } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getErrorMessage"])(error);
                toast({
                    variant: "destructive",
                    title: title,
    ...
    const handleEmailSignIn = async (e)=>{
        e.preventDefault();
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["firebaseConfigValid"] || !email || !password) return;
        setIsEmailLoading(true);
        try {
            const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signInWithEmail"])(email, password);
            if (user) {
                toast({
                    title: "Success!",
                    description: "You've successfully signed in."
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c4f642e0._.js.map