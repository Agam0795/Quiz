...
function SignUpPage() {
    ...
    const handleEmailSignUp = async (e)=>{
        ...
        try {
            const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signUpWithEmail"])(name, email, password);
            if (user) {
                toast({
                    title: "Success!",
...
_s(SignUpPage, "/pcwKfHd0sqNxf6ThDiFex47k4k=", false, function() {
    return [
...
//# sourceMappingURL=src_16850081._.js.map