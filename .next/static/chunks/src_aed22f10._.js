...
"[project]/src/components/auth/auth-error-boundary.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
class AuthErrorBoundary extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Component {
    constructor(props){
        super(props);
        this.state = {
            hasError: false
    ...
    componentDidCatch(error, reactErrorInfo) {
        ...
        const authErrorInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseAuthError"])(error);
    ...
    render() {
        if (this.state.hasError && this.state.error) {
            const authErrorInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseAuthError"])(this.state.error);
...
"[project]/src/lib/auth-error-handler.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const handleAuthError = (error, showToast)=>{
    ...
    // Parse the error
    const errorInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseAuthError"])(error);
...
//# sourceMappingURL=src_aed22f10._.js.map